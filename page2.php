...
<main class="contenu">
    ...
    <div class="consigne">
      ...
      <div class="consigne-page">
        <span class="consigne-page-titre">Cette page</span>
        <p>Trouvez une combinaison de quatre touches, à taper dans l'ordre.</p>
      </div>
    </div>
    ...
    <div class="feuille">
      ...
      <p id="texte-enigme">
        ...
        données, pour char<strong>g</strong>er un jeu ou un traitement de texte rudimentaire. À l'époque, la
        mémoire <strong>v</strong>i<strong>v</strong>e se comptait en <strong>k</strong>ilooctets et non en
        ...
        carton, espérant qu'elles <strong>f</strong>onctionneraient encore des années plus tard. Le
        <strong>g</strong>rand public a décou<strong>v</strong>ert ensuite les premiers modems, capables de
        <strong>f</strong>aire crépiter la li<strong>g</strong>ne téléphonique pour se connecter au réseau
        naissant. Ce <strong>f</strong>ut le <strong>v</strong>rai point de départ d'une
        ré<strong>v</strong>olution que personne n'a<strong>v</strong>ait <strong>v</strong>raiment
        <strong>v</strong>ue <strong>v</strong>enir.
      </p>
